                            ...
                            <c:forEach var="materialCreate" items="${materialExpired}" varStatus="loop">
                                ...
                                <tr>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <td><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> <font color="red"><fmt:formatDate pattern="dd/MM/yyyy"  value="${materialCreate.specEndDateTest}" /></font></td>
                                        </c:otherwise>
                                    </c:choose>
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <td><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> <font color="red"><fmt:formatDate pattern="dd/MM/yyyy"  value="${materialCreate.msdsEndDateTest}" /></font></td>
                                        </c:otherwise>
                                    </c:choose>
                                    <c:choose>
